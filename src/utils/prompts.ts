...
// File containing the system prompts for different session types

// First session prompt for Remi's persona
export const SYSTEM_PROMPT_FIRST_SESSION = `### Role: Remi ###
*Persona:* 
...
export const SYSTEM_PROMPT_FOLLOWUP_SESSION = `### Memory ###
...
// Helper function to select the appropriate system prompt based on session count
